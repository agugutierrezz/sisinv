...
RSpec.describe "API::V1::People#index archivado/filtros", type: :request do
  ...
  p1  = Persona.create!(nombre: "Ana",   apellido: "García", identificador: "ID-ANA-001", archivado: false)
  _p2 = Persona.create!(nombre: "Bruno", apellido: "García", identificador: "ID-BRU-001", archivado: false)
